      ...
      <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex-1 max-w-lg mt-8">
            ...
            <div className="space-y-4 text-foreground">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm">Макс верит, что каждая игра — это целая вселенная, которую он строит с нуля.</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-accent mt-1">*</span>
                <p className="text-sm">Его миссия — создавать Roblox-игры, в которые хочется возвращаться снова и снова.</p>
              </div>
            </div>
          </div>
        ...
        <div id="contact" className="w-full px-6 py-16 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-0 border-t border-border mt-16">
          <div className="flex flex-col md:flex-row gap-2 text-center md:text-left">
            <h2 className="text-foreground font-mono text-xl font-bold">Поиграем вместе?</h2>
            <p className="text-foreground font-mono font-normal text-base">Roblox-разработчик, который строит миры</p>
          </div>
